...
description: 'Start building awesome AI Characters for your game in under 5 minutes'
---
...
Take a note of the Character ID. You'll need it in the next step!
...
Take a note of the Room ID. You’ll need it in the next step!
...
Take a note of the Room ID, which is returned in the `id` field of the response. You’ll need it in the next step!
...
<CodeGroup>
  ...
  // First message event with a partial sentence
  {
    ...
    "data": {
      ...
      "room_id": "cm3tahh0y00a90apgbk4bh8ua",
      "contents": [
        {
          "text": {
            "message": "Meow"
