...
You can explore the capabilities of our Characters using our [AI Playground](https://playground.genova.gg/) tool or by building one with the [4-step Devs Quickstart Guide](/quickstart-guide).
